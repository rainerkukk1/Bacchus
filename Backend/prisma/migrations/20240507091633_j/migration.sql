/*
  ...
  - You are about to drop the column `fullname` on the `AuctionItem` table. All the data in the column will be lost.
  - Added the required column `bid_time` to the `AuctionItemBidAmount` table without a default value. This is not possible if the table is not empty.
...
INSERT INTO "new_AuctionItemBidAmount" ("auctionItem_id", "bid_amount", "id", "user_id") SELECT "auctionItem_id", "bid_amount", "id", "user_id" FROM "AuctionItemBidAmount";
